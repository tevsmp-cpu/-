          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex border border-gray-200 rounded-lg overflow-hidden h-9">
              <motion.button
                ...
                className={cn(
                  "px-3 flex items-center gap-2 text-xs font-semibold transition-colors outline-none focus-visible:ring-inset focus-visible:ring-2 focus-visible:ring-red-500 focus-visible:z-10",
              ...
              <motion.button
                ...
                className={cn(
                  "px-3 border-l border-gray-200 flex items-center gap-2 text-xs font-semibold transition-colors outline-none focus-visible:ring-inset focus-visible:ring-2 focus-visible:ring-red-500 focus-visible:z-10",
            ...
            {/* Category Filter */}
            <div className="flex flex-wrap gap-0.5 bg-gray-100 p-0.5 rounded-lg max-w-2xl">
              {categories.map((cat) => (
                <motion.button
                  key={cat}
                  type="button"
