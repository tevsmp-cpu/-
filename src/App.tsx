          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex border border-gray-200 rounded-lg overflow-hidden h-9">
              <button 
                ...
                className={cn(
                  "px-3 flex items-center gap-2 text-xs font-semibold transition-colors outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-red-500",
              ...
              <button 
                ...
                className={cn(
                  "px-3 border-l border-gray-200 flex items-center gap-2 text-xs font-semibold transition-colors outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-red-500",
